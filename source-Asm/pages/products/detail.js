    ...
    async render(id) {
        ...
        <!--<div class="max-w-7xl mx-auto py-10 grid grid-cols-2 gap-8">
            ...
            <div>
                ...
                <button id="btnAddToCart" class="block bg-red-700  text-2xl uppercase w-full py-5 my-5">Chọn mua</button>
            </div>
        </div>
            -->
  ...
  <div class="pt-6">
    <nav aria-label="Breadcrumb">
      <ol role="list" class="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <li>
          <div class="flex items-center">
            <a href="/products" class="mr-2 text-sm font-medium text-gray-900"> Product Page </a>
            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-4 h-5 text-gray-300">
              <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
            </svg>
          </div>
    ...
    <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
      ...
      <div class="mt-4 lg:mt-0 lg:row-span-3">
        ...
        <div class="mt-10">
          ...
          <div class="mt-10">
            ...
            <input type="number" id="inputValue" class="border-neutral-500 focus:ring-indigo-500 focus:border-indigo-500 block w-full mt-5 pl-7 pr-12 sm:text-sm  border-orange-200 rounded-md"/>
            <div>
      ...
      <div class="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900">The ${data.name} allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: &quot;Black&quot;. Need to add an extra pop of color to your outfit? Our white tee has you covered.</p>
          </div>
        </div>
